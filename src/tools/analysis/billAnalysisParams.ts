...
export const TOOL_DESCRIPTION = `Fetches comprehensive data about a congressional bill from multiple Congress.gov API endpoints in parallel. Returns structured data including bill details, sponsor, status, cosponsors, committees, subjects, related bills, and full action history.

The AI client should analyze the returned data to assess passage likelihood, significance, controversy, and other qualitative judgments.
